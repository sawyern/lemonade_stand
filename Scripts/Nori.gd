...
func _ready():
	$Nori_1.text = Constants.NORI_1_QTY as String + " for " + Constants.as_currency(Constants.NORI_1_QTY * Constants.NORI_1_PRICE)
	$Nori_2.text = Constants.NORI_2_QTY as String + " for " + Constants.as_currency(Constants.NORI_2_QTY * Constants.NORI_2_PRICE)
	$Nori_3.text = Constants.NORI_3_QTY as String + " for " + Constants.as_currency(Constants.NORI_3_QTY * Constants.NORI_3_PRICE)
	_update_label()
