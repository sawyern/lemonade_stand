...
func _ready():
	$Wrap_1.text = Constants.WRAP_1_QTY as String + " for " + Constants.as_currency(Constants.WRAP_1_QTY * Constants.WRAP_1_PRICE)
	$Wrap_2.text = Constants.WRAP_2_QTY as String + " for " + Constants.as_currency(Constants.WRAP_2_QTY * Constants.WRAP_2_PRICE)
	$Wrap_3.text = Constants.WRAP_3_QTY as String + " for " + Constants.as_currency(Constants.WRAP_3_QTY * Constants.WRAP_3_PRICE)
	_update_label()
