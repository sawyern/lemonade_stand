...
func _ready():
	$SpamHbox/Spam_1.text = Constants.SPAM_1_QTY as String + " for " + Constants.as_currency(Constants.SPAM_1_QTY * Constants.SPAM_1_PRICE)
	$SpamHbox/Spam_2.text = Constants.SPAM_2_QTY as String + " for " + Constants.as_currency(Constants.SPAM_2_QTY * Constants.SPAM_2_PRICE)
	$SpamHbox/Spam_3.text = Constants.SPAM_3_QTY as String + " for " + Constants.as_currency(Constants.SPAM_3_QTY * Constants.SPAM_3_PRICE)
	_update_label()
